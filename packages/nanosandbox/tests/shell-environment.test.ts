...
/**
 * Comprehensive shell environment tests.
 * Tests coreutils commands, pipes, redirections, and shell features.
 */
describe("Shell Environment", () => {
	...
	describe("Coreutils - File Operations", () => {
	...
	describe("Coreutils - Text Processing", () => {
		...
		it("should read last lines with bash", async () => {
			const vm = await runtime.run("bash", {
		...
		it("should sort using bash array", async () => {
			const vm = await runtime.run("bash", {
